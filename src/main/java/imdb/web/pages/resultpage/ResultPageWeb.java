...
public class ResultPageWeb extends BasePageObject implements ResultPage {
    @FindBy(xpath = "//*[@id=\"title-overview-widget\"]/div[1]/div[2]/div/div[2]/div[2]/h1")
    protected WebElement resultTitle;

    public ResultPageWeb(AutomationDriver driver) {
        super(driver);
    }

    @Override
    public boolean isPageLoaded() {
        logger.info("Verifying that result page is loaded by checking that title header is visible");
